package it.unisalento.db.crud.configurations;
...
@EnableJpaRepositories("it.unisalento.db.crud.repositories")
...
public class JPAConfigurations {
    ...
    private Properties hibProperties() {
        ...
        properties.put(PROPERTY_NAME_HIBERNATE_DDL, environment.getRequiredProperty(PROPERTY_NAME_HIBERNATE_SHOW_SQL));
